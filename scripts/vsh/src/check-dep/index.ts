...
import { getPackages } from '@yangone/node-utils';
...
const DEFAULT_CONFIG = {
  ...
  // 需要忽略的包
  ignorePackages: [
    '@yangone/backend-mock',
    '@yangone/commitlint-config',
    '@yangone/eslint-config',
    '@yangone/node-utils',
    '@yangone/oxfmt-config',
    '@yangone/oxlint-config',
    '@yangone/stylelint-config',
    '@yangone/tsconfig',
    '@yangone/vite-config',
    '@yangone/vsh',
  ],
